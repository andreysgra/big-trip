  ...
  return (
    `<form class="trip-filters" action="#" method="get">
        <div class="trip-filters__filter">
          <input id="filter-everything" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filtevalue="everything" checked>
...
const getEventsComponent = (eventsNumber) => {
  const events = new Array(eventsNumber).fill(``);

  events.forEach((value, index, array) => {
    array[index] = getEventComponent();
  });
